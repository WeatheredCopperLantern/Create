...
public final class AllRedstoneLinkables {
	...
	public static final Holder.Reference<RedstoneLinkableType> REDSTONE_CONTROLLER = AllRedstoneLinkables.register("redstone_controller", RedstoneControllerLinkable::new);
