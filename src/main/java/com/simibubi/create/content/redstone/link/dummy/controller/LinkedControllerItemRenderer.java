...
import com.simibubi.create.content.redstone.link.dummy.controller.LinkedControllerClientHandler.Mode;
...
public class LinkedControllerItemRenderer extends CustomRenderedItemModelRenderer {
	...
	protected static void render(ItemStack stack, CustomRenderedItemModel model,
		...
		if (renderType == RenderType.NORMAL) {
			...
			active = false;
			boolean noControllerInMain = true;//!AllItems.LINKED_CONTROLLER.isIn(mc.player.getMainHandItem());
