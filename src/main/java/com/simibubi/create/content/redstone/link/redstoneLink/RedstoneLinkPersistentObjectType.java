...
public class RedstoneLinkPersistentObjectType extends PersistentObjectType<RedstoneLinkBlockBoundLinkable> {
	...
	@Override
	public RedstoneLinkBlockBoundLinkable create(final ServerLevel level, final @Nullable BlockPos pos, final @Nullable BlockState state) {
		return RedstoneLinkBlockBoundLinkable.create(level, pos, state);
	}
