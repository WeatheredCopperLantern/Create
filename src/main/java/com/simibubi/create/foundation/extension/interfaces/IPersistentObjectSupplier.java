...
public interface IPersistentObjectSupplier {
	...
	default @Nullable BlockBoundObject create$getBlockBoundObject(final BlockPos pos) {
		return null;
	}
	...
	default @Nullable <T extends BlockBoundObject> T create$getBlockBoundObject(final BlockPos pos, final PersistentObjectType<T> type) {
		return null;
	}
