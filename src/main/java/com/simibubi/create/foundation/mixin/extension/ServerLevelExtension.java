...
public abstract class ServerLevelExtension extends Level implements IPersistentObjectSupplier {
	...
	@Override
	public @Nullable BlockBoundObject create$getBlockBoundObject(final BlockPos pos) {
	...
	@Override
	public @Nullable <T extends BlockBoundObject> T create$getBlockBoundObject(final BlockPos pos, final PersistentObjectType<T> type) {
